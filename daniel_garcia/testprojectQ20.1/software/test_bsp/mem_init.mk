...
MEM_2 := qsys_onchip_memory2_1
$(MEM_2)_NAME := onchip_memory2_1
...
$(MEM_2)_HIERARCHICAL_PATH := onchip_memory2_1
$(MEM_2)_WIDTH := 32
...
onchip_memory2_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
