...
module qsys_mm_interconnect_0 (
	...
	wire  [100:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> new_sdram_controller_0_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // new_sdram_controller_0_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> new_sdram_controller_0_s1_agent:cp_channel
	...
	wire  [100:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> timer_0_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // timer_0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire   [24:0] onchip_memory2_1_s1_agent_m0_address;                                               // onchip_memory2_1_s1_agent:m0_address -> onchip_memory2_1_s1_translator:uav_address
	...
	wire  [101:0] onchip_memory2_1_s1_agent_rf_source_data;                                           // onchip_memory2_1_s1_agent:rf_source_data -> onchip_memory2_1_s1_agent_rsp_fifo:in_data
	...
	wire  [101:0] onchip_memory2_1_s1_agent_rsp_fifo_out_data;                                        // onchip_memory2_1_s1_agent_rsp_fifo:out_data -> onchip_memory2_1_s1_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory2_1_s1_agent:cp_data
	...
	wire  [100:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [100:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [100:0] onchip_memory2_1_s1_agent_rp_data;                                                  // onchip_memory2_1_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [100:0] cmd_demux_001_src1_data;                                                            // cmd_demux_001:src1_data -> cmd_mux_004:sink0_data
	...
	wire  [100:0] rsp_demux_004_src0_data;                                                            // rsp_demux_004:src0_data -> rsp_mux_001:sink1_data
	...
	wire          new_sdram_controller_0_s1_agent_rdata_fifo_src_valid;                               // new_sdram_controller_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] new_sdram_controller_0_s1_agent_rdata_fifo_src_data;                                // new_sdram_controller_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          new_sdram_controller_0_s1_agent_rdata_fifo_src_ready;                               // avalon_st_adapter_001:in_0_ready -> new_sdram_controller_0_s1_agent:rdata_fifo_src_ready
	...
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> new_sdram_controller_0_s1_agent:rdata_fifo_sink_data
