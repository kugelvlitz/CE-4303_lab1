...
(
    ...
    localparam PAD14 = log2ceil(64'h40050d0 - 64'h40050c0); 
    localparam PAD15 = log2ceil(64'h40050e0 - 64'h40050d0); 
    localparam PAD16 = log2ceil(64'h40050f0 - 64'h40050e0); 
    localparam PAD17 = log2ceil(64'h4005100 - 64'h40050f0); 
    localparam PAD18 = log2ceil(64'h4005110 - 64'h4005100); 
    // -------------------------------------------------------
    ...
    // ( 0x4005050 .. 0x4005060 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h4005050  && read_transaction  ) begin
            src_channel = 20'b0001000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x4005060 .. 0x4005070 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 27'h4005060  && read_transaction  ) begin
            src_channel = 20'b0000100000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 15;
    end

    // ( 0x4005070 .. 0x4005080 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 27'h4005070  && read_transaction  ) begin
            src_channel = 20'b0000010000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 16;
    end

    // ( 0x4005080 .. 0x4005090 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 27'h4005080  && read_transaction  ) begin
    ...
    // ( 0x40050b0 .. 0x40050c0 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 27'h40050b0   ) begin
            src_channel = 20'b0000000001000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x40050c0 .. 0x40050d0 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 27'h40050c0   ) begin
            src_channel = 20'b0000000000100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x40050d0 .. 0x40050e0 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 27'h40050d0   ) begin
            src_channel = 20'b0000000000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x40050e0 .. 0x40050f0 )
    if ( {address[RG:PAD16],{PAD16{1'b0}}} == 27'h40050e0   ) begin
            src_channel = 20'b0000000000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x40050f0 .. 0x4005100 )
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 27'h40050f0   ) begin
            src_channel = 20'b0000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0x4005100 .. 0x4005110 )
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 27'h4005100  && read_transaction  ) begin
