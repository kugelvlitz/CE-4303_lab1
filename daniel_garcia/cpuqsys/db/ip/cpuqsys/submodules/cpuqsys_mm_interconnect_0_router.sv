...
(
    ...
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h40050f0;
    ...
    // ( 0x4005040 .. 0x4005050 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 27'h4005040  && read_transaction  ) begin
    ...
    // ( 0x40050e0 .. 0x40050f0 )
    if ( {address[RG:PAD16],{PAD16{1'b0}}} == 27'h40050e0  && read_transaction  ) begin
