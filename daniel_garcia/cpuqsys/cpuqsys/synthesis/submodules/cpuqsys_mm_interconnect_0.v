...
module cpuqsys_mm_interconnect_0 (
	...
	wire  [103:0] ram_0_s1_agent_rf_source_data;                                                      // ram_0_s1_agent:rf_source_data -> ram_0_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] ram_0_s1_agent_rsp_fifo_out_data;                                                   // ram_0_s1_agent_rsp_fifo:out_data -> ram_0_s1_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> ram_0_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // ram_0_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> ram_0_s1_agent:cp_channel
	...
	wire  [103:0] pio_continue_0_s1_agent_rf_source_data;                                             // pio_continue_0_s1_agent:rf_source_data -> pio_continue_0_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] pio_continue_0_s1_agent_rsp_fifo_out_data;                                          // pio_continue_0_s1_agent_rsp_fifo:out_data -> pio_continue_0_s1_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pio_continue_0_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // pio_continue_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> pio_continue_0_s1_agent:cp_channel
	...
	wire  [103:0] pio_leds_0_s1_agent_rf_source_data;                                                 // pio_leds_0_s1_agent:rf_source_data -> pio_leds_0_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] pio_leds_0_s1_agent_rsp_fifo_out_data;                                              // pio_leds_0_s1_agent_rsp_fifo:out_data -> pio_leds_0_s1_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_leds_0_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // pio_leds_0_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_leds_0_s1_agent:cp_channel
	...
	wire  [102:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> new_sdram_controller_0_s1_agent:cp_data
	...
	wire  [103:0] rom_0_s1_agent_rf_source_data;                                                      // rom_0_s1_agent:rf_source_data -> rom_0_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] rom_0_s1_agent_rsp_fifo_out_data;                                                   // rom_0_s1_agent_rsp_fifo:out_data -> rom_0_s1_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> rom_0_s1_agent:cp_data
	...
	wire  [102:0] ram_0_s1_agent_rp_data;                                                             // ram_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [102:0] pio_continue_0_s1_agent_rp_data;                                                    // pio_continue_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [102:0] pio_leds_0_s1_agent_rp_data;                                                        // pio_leds_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [102:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [102:0] rom_0_s1_agent_rp_data;                                                             // rom_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [102:0] cmd_demux_001_src1_data;                                                            // cmd_demux_001:src1_data -> cmd_mux_006:sink0_data
	...
	wire  [102:0] rsp_demux_006_src0_data;                                                            // rsp_demux_006:src0_data -> rsp_mux_001:sink1_data
	...
	cpuqsys_mm_interconnect_0_router_008 router_008 (
