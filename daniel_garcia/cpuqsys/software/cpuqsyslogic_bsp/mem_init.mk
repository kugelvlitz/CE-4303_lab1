...
$(MEM_1)_START := 0x04002000
$(MEM_1)_END := 0x04003fff
$(MEM_1)_SPAN := 0x00002000
$(MEM_1)_HIERARCHICAL_PATH := ram_0
$(MEM_1)_WIDTH := 32
...
.PHONY: ram_0
ram_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
